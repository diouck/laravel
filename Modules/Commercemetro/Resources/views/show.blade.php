...
<div class="container">
	<section class="content-header">
		...
		@else	
			<h1>{{ $post->slug }}</h1>
		@endif
		@if (session()->get('auth.commercemetro.moderator') || session()->get('auth.commercemetro.contributor')) 
			<ol class="breadcrumb">
				<li>
					<a href="/commercemetro/{{$post->id}}/edit" class="dropdown-toggle"  role="button" target="_blank">Modifier</a>
				</li>
			</ol>
		@endif
	</section>
				...
				<div class="row">
					<div class="col-md-6 col-xs-12">
						<div class="box box-primary">
							...
							<div class="box-body singlemap" id="singlemap"></div>
						</div>
					</div>
					<div class="col-md-6 col-xs-12">
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">Vue de la rue</h3>
							</div>
							<div class="box-body singlemap" id="pano"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-12">
						<div class="box box-primary">
							...
							<div class="box-body">
								<div id="typo_commerce" class="chart" style="height: 300px;"></div>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="row">
							...
							<div class="box-body">
								<table class="table table-bordered table-striped table-hover" style="height:330px;">
									...
									<tbody>
										<tr>
											<td>Vacants</td>
											<td>@if(!empty($content->vente_0))<span class="badge bg-teal"> {{$content->vente_0}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
										...
										<tr>
											<td>Drive</td>
											<td>@if(!empty($content->vente_5))<span class="badge bg-teal"> {{$content->vente_5}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
											<td>Commerce en kiosque</td>
											<td>@if(!empty($content->vente_6))<span class="badge bg-teal"> {{$content->vente_6}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
											<td>Food truck</td>
											<td>@if(!empty($content->vente_7))<span class="badge bg-teal"> {{$content->vente_7}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
											<td>Guichet automatique</td>
											<td>@if(!empty($content->vente_8))<span class="badge bg-teal"> {{$content->vente_8}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
											<td>Concessionnaire et garage</td>
											<td>@if(!empty($content->vente_10))<span class="badge bg-teal"> {{$content->vente_10}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
										<tr>
											<td>Autres</td>
											<td>@if(!empty($content->vente_9))<span class="badge bg-teal"> {{$content->vente_9}} </span> @else <span class="badge bg-teal"> 0 </span> @endif</td>
										</tr>
									</tbody>
								</table>
							</div>
					...
					<div class="col-md-6 col-xs-12">
						<div class="box box-primary">
							...
							<div class="box-body">
								<div id="typo_surface" class="chart" style="height: 300px;"></div>
							</div>
						</div>
					</div>
				</div>
...
@section('scripts')
        ...
        <script type="text/javascript">
			...
			$(".activite").on('shown.bs.tab', function (e) {
				$("#typo_commerce").empty();
			...
			$(".vente").on('shown.bs.tab', function (e) {
				$("#typo_surface").empty();
