...
<div class="container">
	<section class="content-header">
		...
		@else	
			<h1>{{ $post->slug }}</h1>
		@endif
		@if (session()->get('auth.webmap.moderator') || session()->get('auth.webmap.contributor')) 
			<ol class="breadcrumb">
				<li>
					<a href="/webmap/{{$post->id}}/edit" class="dropdown-toggle"  role="button" target="_blank">Modifier</a>
				</li>
			</ol>
		@endif
	</section>
