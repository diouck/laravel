...
use Modules\Webmap\Repositories\RevisionRepository;
use Modules\Webmap\Http\Requests\RevisionCreateRequest;
use Modules\Webmap\Http\Requests\RevisionUpdateRequest;
use Modules\Webmap\Entities\Post;
...
class RevisionController extends Controller {
    ...
    public function newStore(RevisionCreateRequest $request)
    {
        ...
        return redirect('webmap')->with('success', 'Pôle commercial créé et en attente de modération');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('webmap/admin/revisions')->with('ok', 'Pôle commercial en attente supprimé');
    }
}